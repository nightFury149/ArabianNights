...
* Press A to move character to the left

* Press	D	to move character to the right

* Press W to make the character jump

* Left-click to attack

* Press Spacebar to skip story cutscenes

* Press M	to Return to main menu from game

* Press R	to Restart current level after game over
